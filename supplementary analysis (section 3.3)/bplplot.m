...
% Figure parameters
fntsize = 22;             % Font size 
%mkrwid = 2;              % Marker width   %changed: remove marker
%mkrsize = 10;            % Marker size    %changed: remove marker

clrdat = [0.91 0.41 0.17]; % Color for data (red )
clrfit = [0 0.5 0.7];      % Color for fit  (blue)
lndat = 3;                 % Line width for data
